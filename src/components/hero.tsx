...
export default function Hero() {
  return (
    <section className="flex flex-col-reverse md:flex-row items-stretch md:min-h-[600px]">
      <div className="ml-50 flex-1 flex flex-col items-center justify-center md:items-start text-[#242424]">
        <h2 className=" mb-6 text-4xl md:text-5xl font-extrabold max-w-md text-center md:text-left">
